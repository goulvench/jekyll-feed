...
describe(JekyllFeed) do
  ...
  it "puts all the posts in the feed.xml file" do
    expect(contents).to match %r!http://example.org/updates/jekyll/2014/03/04/march-the-fourth.html!
  ...
  context "with a baseurl" do
    ...
    it "correctly adds the baseurl to the posts" do
      expect(contents).to match %r!http://example.org/bass/updates/jekyll/2014/03/04/march-the-fourth.html!
  ...
  context "categories" do
    context "with top-level post categories" do
      ...
      it "outputs the category feed" do
        ...
        expect(news_feed).to_not match %r!http://example.org/updates/jekyll/2014/03/04/march-the-fourth.html!
  ...
  context "collections" do
    ...
    context "when initialized as an array" do
      ...
      it "outputs the collection feed" do
        ...
        expect(collection_feed).to_not match %r!http://example.org/updates/jekyll/2014/03/04/march-the-fourth.html!
